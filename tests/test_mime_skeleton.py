...
class HtmlAsJsonEngine:
    ...
    def crawl(self, work: CrawlWork) -> CrawlResult:
        return CrawlResult(
            ...
            body=b"<html><title>nope</title></html>",
...
def test_mismatched_content_type_does_not_persist() -> None:
    ...
    with pytest.raises(PermissionError, match="content_type_mismatch"):
