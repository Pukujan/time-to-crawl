...
class Soft404Engine:
    ...
    def crawl(self, work: CrawlWork) -> CrawlResult:
        return CrawlResult(
            ...
            status=200,
            headers=(),
            body=b"<title>404 Not Found</title><p>not found</p>",
...
def test_soft_404_does_not_persist() -> None:
    ...
    with pytest.raises(PermissionError, match="soft_404"):
